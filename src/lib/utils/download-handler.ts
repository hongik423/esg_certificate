...
export const certificationDocuments: DownloadDocument[] = [
  ...
  },
  {
    ...
    fileName: 'ISO_45001_위험성평가가이드.md',
    fileType: 'md',
    size: '65KB',
    category: 'iso-45001',
    icon: 'AlertTriangle',
