    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white">
      ...
      <section className="relative min-h-screen bg-gradient-to-br from-slate-900 via-green-900 to-emerald-900 overflow-hidden">
        ...
        <div className="absolute inset-0 will-change-transform">
          ...
          <div className="absolute top-20 left-20 w-32 h-32 md:w-52 md:h-52 bg-gradient-to-br from-green-400/20 to-emerald-400/20 rounded-full blur-2xl animate-morph"></div>
          <div className="absolute top-40 right-16 w-40 h-40 md:w-60 md:h-60 bg-gradient-to-br from-emerald-400/20 to-teal-400/20 rounded-full blur-2xl animate-morph-reverse"></div>
          <div className="absolute bottom-32 left-1/3 w-36 h-36 md:w-48 md:h-48 bg-gradient-to-br from-teal-400/20 to-green-400/20 rounded-full blur-2xl animate-morph-slow"></div>
          ...
          <div className="max-w-6xl mx-auto text-center">
            ...
            >
              <div className="relative">
                <GraduationCap className="w-4 h-4 sm:w-5 sm:h-5 mr-2 sm:mr-3 text-green-400" />
              ...
              <div className="flex items-center space-x-1 ml-2">
                ...
                <Lightbulb className="w-3 h-3 sm:w-4 sm:h-4 text-teal-400 animate-pulse" style={{animationDelay: '0.5s'}} />
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 mb-12 sm:mb-16 animate-fade-in-up-ai" style={{animationDelay: '1.2s'}}>
              {[
                { icon: Target, title: '맞춤형 교육', desc: 'AI 기반 개인화 학습', color: 'green' },
                { icon: TrendingUp, title: '실무 중심', desc: '현장 적용 가능한 교육', color: 'emerald' },
                { icon: Award, title: '자격증 취득', desc: '공인 수료증 발급', color: 'teal' },
                { icon: Users, title: '전문 강사진', desc: '현장 경험 풍부한 전문가', color: 'green' }
              ].map((feature, index) => (
                <div 
                  key={index}
